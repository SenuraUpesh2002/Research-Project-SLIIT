...
const EntryPage = () => {
  ...
  return (
    <div className={styles.portalWrapper}>
      {/* Logo at the top */}
      <img src={logo} alt="FuelWatch Logo" className={styles.logo} />

      <h1 className={styles.title}>Welcome to FUELWATCH</h1>
      <p className={styles.subtitle}>Select your portal to continue</p>

      <div className={styles.portalCards}>
        <div
          className={`${styles.portalCard} ${loaded ? styles.fadeIn : ''}`}
